...
export default function RunningCoachView({ onNext }: RunningCoachViewProps) {
  ...
  return (
    <div id="running-coach-view" className="flex flex-col h-full bg-[#0a0d16] text-[#eef2f6] select-none">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-5">
        ...
        <div className="bg-cyan-950/20 border border-cyan-900/30 p-3 rounded-xl flex items-start gap-3 backdrop-blur-sm">
