...
export default function RunningCoachView({ onNext }: RunningCoachViewProps) {
  ...
  return (
    <div id="running-coach-view" className="flex flex-col h-full bg-[#0a0d16] text-[#eef2f6] px-4 py-4 justify-between select-none">
      {/* Top Smartwatch Header */}
      <div className="text-center">
        <span className="text-xs uppercase tracking-wider font-mono text-cyan-400 font-semibold bg-cyan-950/40 px-3 py-1 rounded-full border border-cyan-800/30 inline-block mt-1">
        ...
        <p className="text-sm text-slate-405 mt-1 px-1 leading-relaxed">
          Đo lường nhịp độ, tư thế và vùng nhịp tim ổn định tại thảm chạy sự kiện.
        </p>
      </div>
        ...
        <div className="space-y-2.5">
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-slate-200">1. Đeo đồng hồ Galaxy Watch8</p>
              <p className="text-xs text-slate-500 mt-0.5">Liên hệ điều phối viên tại trạm để đeo thử đồng hồ</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-slate-200">2. Thực hiện chạy tại chỗ</p>
              <p className="text-xs text-slate-500 mt-0.5">Bắt đầu sải chân nhịp nhàng trên thảm trong vòng 1-2 phút</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-slate-200">3. Xem phân tích nhịp tim</p>
              <p className="text-xs text-slate-500 mt-0.5">Kiểm tra vùng nhịp tim Zone 2 tối ưu đốt mỡ trên mặt đồng hồ</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-cyan-950/20 border border-cyan-900/30 p-3 rounded-xl flex items-start gap-3 mb-3.5">
        <div className="bg-cyan-950 p-2 rounded-xl border border-cyan-800/40 text-cyan-400 mt-0.5 shrink-0">
          <Footprints className="w-4 h-4 text-cyan-400" />
        </div>
        <div>
          <h4 className="text-xs font-semibold text-white font-display">Gợi ý từ HLV Sự kiện</h4>
          <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">
            Chạy bộ thẳng lưng, hạ bàn chân bằng nửa trước để cảm biến Watch8 đo đạc chính xác tư thế nâng sải của bạn.
          </p>
        </div>
      </div>
      ...
      <button
        ...
        onClick={onNext}
        className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-display font-semibold text-base py-3.5 px-4 rounded-xl shadow-lg transition-all duration-200 active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2 border border-cyan-500/30"
      >
